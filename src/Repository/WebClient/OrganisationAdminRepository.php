...
class OrganisationAdminRepository {
	...
	public function apprenticeship_details(VO\Token $token, VO\ApprenticeshipID $apprenticeship_id) {
		...
		$request = new Request(
			new GuzzleClient,
			$this->credentials,
			VO\HTTP\Url::fromNative($this->base_url.'/organisation/admin/apprenticeship/'.$apprenticeship_id.'/details'),
			new VO\HTTP\Method('GET')
		);
	...
	public function apprentice_documents(vo\Token $token, VO\Integer $apprentice_id)
	{
		$request = new Request(
			new GuzzleClient,
			$this->credentials,
			VO\HTTP\Url::fromNative($this->base_url.'/organisation/admin/get/apprentice/'.$apprentice_id->__toInteger().'/documents'),
			new VO\HTTP\Method('GET')
		);
